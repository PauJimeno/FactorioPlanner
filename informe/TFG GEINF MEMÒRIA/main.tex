...
\supervisorAmail{mateu.villaret@udg.edu}         % Email address of supervisor 1,      \supmailA
...
\include{Capítols/Introducció}
\include{Capítols/EstudiDeViabilitat}
\include{Capítols/Metodologia}
\include{Capítols/Planificacio}
\include{Capítols/MarcDeTreballIConceptesPrevis}
\include{Capítols/RequisitsDelSistema}
\include{Capítols/EstudisIDecisions}
\include{Capítols/DissenyDelModel}
\include{Capítols/DissenyDelFrontEnd}
\include{Capítols/AnalisiDelsExperiments}
\include{Capítols/Conclusions}
\include{Capítols/TreballFutur}
